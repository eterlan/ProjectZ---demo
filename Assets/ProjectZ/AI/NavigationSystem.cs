...
using Tree = ProjectZ.Component.Tree;
...
namespace ProjectZ.AI
{
    public class NavigationSystem : JobComponentSystem
    {
        ...
        protected override JobHandle OnUpdate(JobHandle inputDependency)
        {
            ...
            var behaviourTargets = new NativeArray<BehaviourType>(npcCount, Allocator.TempJob);
        ...
        [BurstCompile]
        public struct CopyBehaviourTargets : IJobForEachWithEntity<CurrentBehaviour>
        {
            public NativeArray<BehaviourType> BehaviourTargets;

            public void Execute(Entity entity, int index, [ReadOnly] ref CurrentBehaviour currentBehaviourTarget)
            {
                BehaviourTargets[index] = currentBehaviourTarget.BehaviourType;
            }
        }
        ...
        public struct FindClosestTarget : IJobForEachWithEntity<Translation>
        {
            ...
            [DeallocateOnJobCompletion] [ReadOnly] public NativeArray<BehaviourType> BehaviourTargets; // use enum?
        ...
        [BurstCompile]
        public struct Movement : IJobForEachWithEntity<Translation, MovementSpeed, Rotation, Navigation>
        {
            ...
            public void Execute(Entity entity, int index, ref Translation translation,
                [ReadOnly] ref MovementSpeed movementSpeed, ref Rotation rotation, ref Navigation navigation)
            {
